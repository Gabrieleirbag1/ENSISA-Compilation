...
__REGEXP_7__ = ")"
__REGEXP_8__ = [0-9]+
__REGEXP_9__ = [A-Za-z_][A-Za-z_0-9]*
__REGEXP_10__ = \r\n|\r|\n
__REGEXP_11__ = "/*"
__REGEXP_12__ = "*/"
__REGEXP_13__ = [^]
...
<YYINITIAL> {
  ...
  {__REGEXP_7__}		{ return symbol(ETerminal.__REGEXP_7__); }
  {__REGEXP_14__}		{  }
  {__REGEXP_10__}		{ return symbol(ETerminal.EOLN); }
  {__REGEXP_11__}		{ startRegion (COMMENT$State); }
  {__REGEXP_8__}		{ return symbol(ETerminal.NUMBER, Integer.parseInt(yytext())); }
  {__REGEXP_9__}		{ return symbol(ETerminal.ID, yytext()); }
}
